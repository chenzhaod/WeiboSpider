...
# (2) create/maintain a "comment_output_log.json" file to log the tracking process
# (3) create/maintain a "comment_group_tracking_status.json" file to log the current tracking status of each group
# (4) create/maintain a "comment_error_log" file to log the failed cases of repost tracking
...
def rename_output_file(dbx,
                       ...
                       dropbox_output_dir="/Dissertation/weibo_data/comment_output/",
                       error_log_file="/Dissertation/weibo_data/records_and_logs/comment_error_log.json"):
    """
...
def log(dbx,
        new_file_name,
        group_range_file="/Dissertation/weibo_data/records_and_logs/group_number_range.txt",
        tracking_log_file="/Dissertation/weibo_data/records_and_logs/comment_output_log.json",
        group_status_log_file="/Dissertation/weibo_data/records_and_logs/comment_group_tracking_status.json"):
    """
...
def record_group_tracking_status(dbx,
                                 group_number,
                                 tracking_status_file="/Dissertation/weibo_data/records_and_logs/comment_group_tracking_status.json"):
    """
...
def log_error(dbx, error_message, error_log_file="/Dissertation/weibo_data/records_and_logs/comment_error_log.json"):
    """
...
if __name__ == "__main__":
    access_token = os.environ.get('ACCESS_TOKEN') # replace with environment variable later
    if not access_token:
